...
public class ThemeFruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_theme_fruit);

        appleCard = (View) findViewById(R.id.appleCard);
        ...
        orangeCard = (View) findViewById(R.id.orangeCard);
        ...
        strawberryCard = (View) findViewById(R.id.strawberryCard);
        strawberryCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                uploadInfo("strawberry");
            }
        });
    }
